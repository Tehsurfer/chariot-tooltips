...
class Tooltip {
  ...
  _buttonsMarkup(centered) {
    ...
    const buttons = [`<button class="btn btn-inverse btn-next ${buttonFloat}">${this.ctaNext}</button> <button id="chariot-exit" class="right btn" style=" background-color: transparent; color: #c50261; ">Skip</button>`];
